...
const SectionsSwitch = ({ page }: { page: string }) => {
  const selectedStyle =
    'px-4 bg-black dark:bg-white text-white dark:text-black rounded-full py-[2px] '
  const secondaryStyle =
    'px-4 text-grey rounded-full hover:bg-border-light py-[2px] transition-all duration-200'
